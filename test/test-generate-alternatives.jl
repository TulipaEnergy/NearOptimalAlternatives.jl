@testset "Test generate alternatives without any specific method." begin
    @testset "Make sure error is thrown when JuMP model is not solved." begin
        ...
        @test_throws ArgumentError NearOptimalAlternatives.generate_alternatives_optimization!(
            model,
            0.1,
            all_variables(model),
            5,
...
@testset "Test generate alternatives using metaheuristics." begin
    @testset "Make sure error is thrown when JuMP model is not solved." begin
        ...
        @test_throws ArgumentError generate_alternatives_metaheuristics(
            model,
            0.1,
            5,
            algorithm,
    ...
    @testset "Test regular run with one alternative." begin
        ...
        results = generate_alternatives_metaheuristics(model, 0.1, 1, algorithm)
    ...
    @testset "Test regular run with one alternative with one fixed variable." begin
        ...
        results = generate_alternatives_metaheuristics(
            model,
            0.1,
            1,
            algorithm,
    ...
    @testset "Test regular run with two alternatives." begin
        ...
        results = generate_alternatives_metaheuristics(model, 0.1, 2, algorithm)
